...
There are only 21853 pseudoprimes base 2 that are less than 2.5×10^10. This means that, for n up to 2.5×1010, if 2n-1 (modulo n) equals 1, then n is prime, unless n is one of these 21853 pseudoprimes.
